...
|10:30 |Mining the literature <ul><li>Learn about what can already be mined from papers and experiment with [extracting species names](https://github.com/ContentMine/Chicago-20141112/blob/master/Species-Names-Demo/ami-species_demo.md).</li></ul>|
|11:00|[Mining data from figure images] (https://github.com/ContentMine/Chicago-20141112/blob/master/Figure-Image-Mining/ami-tree_demo.md) <ul><li> Learn about what can be mined from figure _images_, in this case, figure images containing evolutionary trees.</li></ul>|
...
|15:30| [Legal implications of content mining] (https://github.com/ContentMine/Chicago-20141112/tree/master/Legal-Discussion) <ul><li> Covering the copyright and database rights that impact on contact mining activities, including statutory and case law.</li></ul>|
|16:00| Event close|
